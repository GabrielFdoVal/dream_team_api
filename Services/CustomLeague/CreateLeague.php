<?php
    ...
    function CreateLeague($name, $rounds, $userLength, $private): ResultService {
        $result = new ResultService();
        

        if($name == null || $rounds == null || $userLength == null || $private == null){
        ...
        $code = InsertLeague($name, $rounds, $userLength, $private);
